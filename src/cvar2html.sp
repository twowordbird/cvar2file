...
WriteToHtml(Handle:names, Handle:descriptions, String:filename[])
{
	...
	// write header
	WriteFileLine(cvarhtml, "<p>Below is a list of all console commands and cvars in the current release build of Counter-Strike: Global Offensive (v%s). Filter using the search box below.</p>", version);
